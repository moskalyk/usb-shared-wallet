...
(async () => {
    ...
    // hack to use another aqua definition
    registerFileService({
        serve: async () => {
            console.log('serving')
            return [{name: '', path: '01312205f00d4fa6cd4886dfffd2f97c82dd5f43aab8932161cc526682e3013f95043dca5efc15c63db61aef9802cd3d0e461d5692ffbcb31a220272787a6f825d835bc8b07989893eefc1e908fece27bd0af92d74e7e6f6af15ff6c9a8adf1e27cb26f60411a8f0f33de97950e6003141'}]
        },
        connect: (blob: any) => {
            return true
        }
