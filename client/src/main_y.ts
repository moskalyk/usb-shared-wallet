    ...
    (new $shares
     (seq
      (seq
                 ...
                 (seq
                  (seq
                   (seq
                    ...
                    (call peer-0 ("shamirService" "retrieveShare") [] ret)
                   )
                   (ap ret $shares)
                  )
                  (new $-ephemeral-stream-
       ...
       (canon %init_peer_id% $receipt  #-receipt-fix-0)
      )
      (ap #-receipt-fix-0 -receipt-flat-0)
     )
    )
   )
  )
  (call %init_peer_id% ("callbackSrv" "response") [-receipt-flat-0])
 )
 (call %init_peer_id% ("errorHandlingSrv" "error") [:error: 0])
)
`;
